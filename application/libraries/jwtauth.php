...
include_once APPPATH."/third_party/jwt/vendor/autoload.php";
...
class Jwtauth  {
	...
	protected $cookieBestBefore = 60*60*24; // 이 쿠키 유통기한은 한달 (년일 경우 * 365)
	...
	public function decodeJWT($jwt)
	{
		...
		// 디코딩해 봤는데 유효하 않을 수 있습니다. (다른 Authorization 헤더나 쿠키값이 있어 재수 없이 겹치는 경우 등) 그러면 Signature verification failed 에러가 떨어지는데 이럴 때는 null을 돌려주기로 합니다.
		} catch (Exception $e) {
			return NULL;
		}
	...
	public function setJWT($user, $new = false)
	{
		...
		$jwt = JWT::encode($user, $this->key, 'HS256');
